          ...
          { type === 'number'
            ...
            : (
              <>
                <input
                  className="input__item"
                  type={type && closeEye ? 'text' : 'password'}
                  placeholder={type === 'password' ? 'password' : 'number'}
                />
                <svg
                  viewBox="0 0 128 128"
                  xmlns="http://www.w3.org/2000/svg"
                  onClick={() => setCloseEye(!closeEye)}
                  fill={!closeEye ? 'deepskyblue' : null}
                >
                  {
                  closeEye
